...
namespace FinalProject.Back.Migrations
{
    ...
    [Migration("20240105120446_add_exams_submissionscore")]
    partial class add_exams_submissionscore
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "Nea Smirni",
                            CreatedAt = new DateTime(2024, 1, 5, 14, 4, 45, 792, DateTimeKind.Local).AddTicks(9073),
