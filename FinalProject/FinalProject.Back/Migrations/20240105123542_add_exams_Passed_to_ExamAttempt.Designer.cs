...
namespace FinalProject.Back.Migrations
{
    ...
    [Migration("20240105123542_add_exams_Passed_to_ExamAttempt")]
    partial class add_exams_Passed_to_ExamAttempt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "Nea Smirni",
                            CreatedAt = new DateTime(2024, 1, 5, 14, 35, 42, 479, DateTimeKind.Local).AddTicks(3740),
