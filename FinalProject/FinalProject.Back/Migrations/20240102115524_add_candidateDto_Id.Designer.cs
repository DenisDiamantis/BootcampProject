...
namespace FinalProject.Back.Migrations
{
    ...
    [Migration("20240102115524_add_candidateDto_Id")]
    partial class add_candidateDto_Id
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "Nea Smirni",
                            CreatedAt = new DateTime(2024, 1, 2, 13, 55, 24, 429, DateTimeKind.Local).AddTicks(3309),
